...
Registry& WorldInit::registry = Registry::get_instance();

Entity WorldInit::create_player(glm::vec2 position) {
    auto entity = Entity();
...
Entity WorldInit::create_enemy(glm::vec2 position) {
    auto entity = Entity();
...
Entity WorldInit::create_projectile(glm::vec2 position, glm::vec2 velocity, TEAM_ID team_id) {
    auto entity = Entity();
